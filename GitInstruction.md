...
Зачем нужно использовать системы контроля версий? Системы контроля версий (СКВ) позволяют отслеживать изменения в коде или документах, сохранять историю изменений, работать с несколькими версиями одновременно, сотрудничать в команде над проектом и вносить изменения без риска потерять данные.
