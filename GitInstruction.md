...
Pachyderm. Платформа для сбора данных, позволяющая легко воспроизводить результаты моделей ML, управляя всем рабочим процессом обработки данных.

Dolt. База данных SQL с версиями в стиле Git.

LakeFS. Позволяет командам строить повторяющиеся, атомарные и версионированные операции с данными об озёрах.
